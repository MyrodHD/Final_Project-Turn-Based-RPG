        ...
        public List<Encounter> GetEncountersForLevel(Game1.GameState level)
        {
            ...
            switch (level)
            {
                ...
                case Game1.GameState.Level2:
                    list.Add(new Encounter(new Rectangle(150, 120, 48, 48), new Enemy("Slime", 19, 3, 1)));
                    list.Add(new Encounter(new Rectangle(300, 220, 48, 48), new Enemy("Orc", 22, 6, 10)));
                    list.Add(new Encounter(new Rectangle(420, 340, 48, 48), new Enemy("Wraith", 20, 5, 3)));
                    break;

                case Game1.GameState.Level3:
                    list.Add(new Encounter(new Rectangle(200, 150, 48, 48), new Enemy("Skeleton", 18, 5, 8)));
                    list.Add(new Encounter(new Rectangle(350, 250, 48, 48), new Enemy("Troll", 30, 7, 15)));
